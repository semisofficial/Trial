...
test("checkout validation enforces address, date range, slots, and mains timing", () => {
  ...
  const elevenThirty = new Date("2026-08-20T06:00:00Z"); // 11:30 AM in India
  ...
  expectInvalid(() => validateDeliveryDetails(valid, "Delivery", today, elevenThirty));
  validateDeliveryDetails({ ...valid, deliverySlot: "12-13" }, "Delivery", today, elevenThirty);
  validateMainsTiming([{ categoryId: "mains" }], valid, "Delivery", today);
